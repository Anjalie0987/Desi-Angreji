...
export const metadata: Metadata = {
  title: "About Us | Desi Angreji",
  description: "Learn more about Desi Angreji, our mission, vision, and the team behind the stories.",
}
    ...
    <>
      <Section className="pb-8 pt-6">
        <Container>
          ...
          <H1 className="mb-6 text-4xl font-bold lg:text-5xl">About Desi Angreji</H1>
          <p className="text-xl text-gray-600 max-w-3xl leading-relaxed text-justify">
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-brand/10 p-8 rounded-2xl border border-brand/20">
              <H3 className="text-brand mb-4">Why Desi Angreji?</H3>
