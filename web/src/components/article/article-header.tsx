...
export function ArticleHeader({ article }: { article: ArticleDetail }) {
  return (
    <header className="mb-0">
      {/* Breadcrumb */}
      <nav aria-label="Breadcrumb" className="mb-2 flex items-center text-sm text-gray-500 overflow-x-auto whitespace-nowrap hide-scrollbar">
      ...
      {/* Title */}
      <H1 className="mb-4 border-b-0 pb-0 text-2xl md:text-3xl lg:text-4xl leading-tight font-extrabold text-gray-950">
        {article.title}
      </H1>
